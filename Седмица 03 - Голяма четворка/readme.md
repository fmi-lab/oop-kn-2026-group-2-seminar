...
## Задача 00 - Студент
Да се реализира клас студент, който съдържа име на студента, курс, група, факултетен номер и среден успех. Да се реализират методи за извеждане на подробна информация за студента и за проверка дали студентът може да премине в следващ курс.
