...
- operator[] - връща елемента на подадения индекс. Да се реализира само константна версия (помислете какъв е проблемът с неконстантната);
...
- map - по подадена функция прилага функцията над всеки от елементите и връща нов сортиран масив;
- search - проверява дали подаденият елемент е в масива. Да се реализира чрез метода на двоичното търсене;
- operator<< - извежда елементите на масива в подаден изходен поток.
